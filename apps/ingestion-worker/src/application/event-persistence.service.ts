...
import { Event, EventCandidate, type EventWriter } from '@app/events-domain';
...
export class EventPersistenceService {
  ...
  public async persistEvent(
    ...
    await this.eventWriter.save(
      Event.fromCandidate(randomUUID(), candidate, receivedAt, processedAt),
    );
